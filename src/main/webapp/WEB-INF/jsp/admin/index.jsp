...
<div id="login">
		<form action="../login" method="post">
			<h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户登录</h1>
			<div>
				<input type="text" placeholder="用户名"  name="userAccount"   id="username" /><div id="statuss"></div>
			</div>
			<div>
				<input type="password" placeholder="密码" name="userPwd"  id="password" /><div id="status"></div>
			</div>
			<div>
